...
| MariaDB     | 10.2                    | mariadb-java-client-2.4.0.jar   |
...
For more information, please visit the RHPAM [compatibility matrix](https://access.redhat.com/articles/3405381#RHPAM77).
...
- Using CeKit: This is the preferred way as it assures that the built images will contain the expected files
- Using Dockerfile: legacy way that we had in the past, notice that, the scripts are provided as it is, feel free to use
